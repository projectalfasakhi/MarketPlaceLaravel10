...
class PesananSuperAdminController extends Controller
{
    public function lihat_pesanan()
    {
        ...
        ->get();
        return view('superadmin.pesanan.pesanan_list', compact(['pesanan'])); 
    }
    ...
    public function terima_pesanan($id)
    {
        ...
        return to_route('superadmin.pesanan_prosses');
    }
    ...
    public function pesanan_onprosses()
    {
        ...
        return view('superadmin.pesanan.pesanan_onprosses', compact(['pesanan']));
    }
    ...
    public function pesanan_kirim(Request $request)
    {
        ...
        return to_route('superadmin.pesanan_deliver');
    }
    ...
    public function pesanan_deliver()
    {
        ...
        return view('superadmin.pesanan.pesanan_deliver', compact(['pesanan']));
    }
