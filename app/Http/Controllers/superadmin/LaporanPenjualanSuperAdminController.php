...
class LaporanPenjualanSuperAdminController extends Controller
{
    public function index()
    {
        ...
        ->get();
        return view('superadmin.laporan.laporan',compact(['pesanan']));
    }
    ...
    public function laporan_cari(Request $request)
    {
        ...
        return view('superadmin.laporan.cari_laporan',compact(['pesanan']));
    }
}
