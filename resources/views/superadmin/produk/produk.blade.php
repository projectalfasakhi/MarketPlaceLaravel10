        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <a href="{{ route('produk1.create') }}"class="btn btn-primary"><i class="ti ti-cookie"></i>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($produk as $produk)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('produk1.edit', $produk->id_produk) }}"
                                                    style="color:darkgoldenrod"><i class="ti ti-edit"></i>Edit</a> |
                                                <a href="{{ route('produk1.destroy', $produk->id_produk) }}"
                                                    style="color:red"
                                                ...
                                                <form id="produk-form-{{ $produk->id_produk }}"
                                                    action="{{ route('produk1.destroy', $produk->id_produk) }}"
